    ...
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">{threads.length} active threads</p>
        </div>
                    ...
                    >
                        <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-2">
                                <span className={`p-1.5 rounded-md ${isGeneral ? 'bg-indigo-100 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400' : 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400'}`}>
                        ...
                        <div className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2 leading-relaxed mb-3 h-[2.5em]">
                            {lastMessage ? (
                                <span className={lastMessage.role === 'user' ? 'text-slate-500 dark:text-slate-500' : 'text-slate-800 dark:text-slate-300'}>
